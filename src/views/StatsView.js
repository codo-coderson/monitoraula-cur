      ...
      <div style="max-width: 1000px; margin: 0 auto; padding: 1rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
          ...
          <div style="display: flex; gap: 1rem; align-items: center;">
            <input type="date" id="statsStartDate" value="${this.startDate}" style="padding: 0.5rem; border: 1px solid #ccc; border-radius: 4px;">
            <span>hasta</span>
            <input type="date" id="statsEndDate" value="${this.endDate}" style="padding: 0.5rem; border: 1px solid #ccc; border-radius: 4px;">
